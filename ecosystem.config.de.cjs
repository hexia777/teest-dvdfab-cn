  ...
  apps: [
    {
      ...
      env: {
        ...
        NUXT_PACK_ENV: 'prod',
        NUXT_PUBLIC_API_BASE: 'https://web-backend-api-de.dvdfab.cn',
        NUXT_PUBLIC_API_PREFIX: '/api/',
        NUXT_PUBLIC_API_OM: 'https://servo-slave-de.dvdfab.cn',
        NUXT_PUBLIC_API_PHP: 'https://web-backend-de.dvdfab.cn',
        NUXT_PUBLIC_API_OAPI: 'https://oapi2-de.dvdfab.cn',
        NUXT_PUBLIC_API_TICKET: 'https://ticket-api.dvdfab.cn',
        NUXT_PUBLIC_API_G_OAUTH: 'https://g-auth.dvdfab.cn',
        NUXT_PUBLIC_API_RISK: 'https://user-profile.dvdfab.at',
      },
    },
    {
    ...
    },
    {
      ...
      env: {
        ...
        NODE_ENV: 'production',
        NODE_OPTIONS: '--max-old-space-size=30720',
        CACHE_IPS: '212.95.51.213,212.95.51.214',
        CACHE_HOSTNAME: 'page_cache',
      },
    },
  ],
