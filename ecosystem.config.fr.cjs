  ...
  apps: [
    {
      ...
      env: {
        ...
        NUXT_PACK_ENV: 'prod',
        NUXT_PUBLIC_API_BASE: 'https://web-backend-api-fr.dvdfab.cn',
        NUXT_PUBLIC_API_PREFIX: '/api/',
        NUXT_PUBLIC_API_OM: 'https://servo-slave-fr.dvdfab.cn',
        NUXT_PUBLIC_API_PHP: 'https://web-backend-fr.dvdfab.cn',
        NUXT_PUBLIC_API_OAPI: 'https://oapi2-fr.dvdfab.cn',
        NUXT_PUBLIC_API_TICKET: 'https://ticket-api.dvdfab.cn',
        NUXT_PUBLIC_API_G_OAUTH: 'https://g-auth.dvdfab.cn',
        NUXT_PUBLIC_API_RISK: 'https://user-profile.dvdfab.fr',
      },
    },
    {
