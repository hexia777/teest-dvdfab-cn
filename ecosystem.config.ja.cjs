  ...
  apps: [
    {
      ...
      env: {
        ...
        NUXT_PACK_ENV: 'prod',
        NUXT_PUBLIC_API_BASE: 'https://web-backend-api-ja.dvdfab.cn',
        NUXT_PUBLIC_API_PREFIX: '/api/',
        NUXT_PUBLIC_API_OM: 'https://servo-slave-ja.dvdfab.cn',
        NUXT_PUBLIC_API_PHP: 'https://web-backend-ja.dvdfab.cn',
        NUXT_PUBLIC_API_OAPI: 'https://oapi2-ja.dvdfab.cn',
        NUXT_PUBLIC_API_TICKET: 'https://ticket-api.dvdfab.cn',
        NUXT_PUBLIC_API_G_OAUTH: 'https://g-auth.dvdfab.cn',
        NUXT_PUBLIC_API_RISK: 'https://user-profile.dvdfab.org',
      },
    },
    {
    ...
    },
    {
      ...
      env: {
        ...
        NODE_ENV: 'production',
        NODE_OPTIONS: '--max-old-space-size=30720',
        CACHE_IPS: '45.76.97.182,45.77.13.132,167.179.104.67',
        CACHE_HOSTNAME: 'page_cache',
      },
    },
  ],
